...
public class AttendanceManagementBlazorModule : AbpModule
{
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        app.UseConfiguredEndpoints(builder =>
        {
            builder.MapRazorComponents<App>()
                ...
                .AddAdditionalAssemblies(WebAppAdditionalAssembliesHelper.GetAssemblies<AttendanceManagementBlazorClientModule>());
        });
    }
}
